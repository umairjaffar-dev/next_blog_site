...
const Sidebar = () => {
  return (
    <div className="flex flex-col bg-slate-100">
      ...
      <div className="w-28 sm:w-80 h-[calc(100vh-60px)] relative py-12 border border-black">
        <div className="w-[50%] sm:w-[80%] absolute right-0 flex flex-col gap-3">
          ...
          <Link href="/admin/subscriptions" className="flex items-center border border-black gap-3 font-medium px-3 py-2 bg-white shadow-[-5px_5px_0px_#000000]">
